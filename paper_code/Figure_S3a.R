...
# Comparison of target gene abundances between untargeted long-read RNA-seq and TEQUILA-seq data for fibroblast cell lines CDG-P12
# (CDG-466 gene panel, left) and PMD-C01 (PMD-359 gene panel, right). Only target genes with TPM (transcripts per million) > 1 in 
