...
# Number of known pathogenic variants within exonic regions that were detected and phased by STRIPE using only information
# from TEQUILA-seq data on previously diagnosed patients.
