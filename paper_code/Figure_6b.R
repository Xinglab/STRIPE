...
outfile <- file.path(workdir, "manuscript/Main_Figures/Figure_6/Figure_6b.pdf")
...
tx.info <- read.table(file.path(workdir, "manuscript/Main_Figures/Figure_6/ALG1/sequences.fa"), sep = "\t", 
    header = FALSE) %>% filter(row_number() %% 2 == 1)
inDF <- bind_cols(data.frame(do.call(rbind, strsplit(read.table(file.path(workdir, "manuscript/Main_Figures/Figure_6/ALG1/sequences.fa"), 
