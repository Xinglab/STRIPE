...
# (a) Sashimi plot visualization of haplotype-resolved PIGN splicing patterns in individual CDG-P05. Haplotype 2 carries 
...
# Use ggsashimi.py to visualize haplotype-resolved PIGN splicing patterns in individual CDG-P05
