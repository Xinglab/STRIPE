...
# proportion ≥ 1% in Haplotype 2 or an average isoform-level proportion ≥ 5% across other cohort individuals are displayed 
...
# Only keep transcripts with isoform fraction >= 0.01 in haplotype 2 or average isoform fraction >= 0.05 across other cohort individuals
