...
# TEQUILA-seq data for fibroblast cell lines CDG-152-1 (CDG-466 gene panel, left) and E1877 (PMD-359 gene panel, right). 
...
outfile <- file.path(workdir, "manuscript/Revisions/20241219/Main_Figures/Figure_1/Figure_1e.pdf")
