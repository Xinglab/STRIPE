...
# skipping with an isoform-level proportion ≥ 5% in Haplotype 1 or transcripts with an average isoform-level proportion 
...
# Only keep transcripts featuring PMM2 exon 5 skipping with isoform fraction >= 0.05 in haplotype 1 or average isoform fraction >= 0.1 across other cohort individuals
