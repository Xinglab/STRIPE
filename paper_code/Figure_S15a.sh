...
OUTFILE="$WORKDIR/manuscript/Revisions/20241219/Supplementary_Figures/Figure_S15/Figure_S15a.pdf"
mkdir -p "$WORKDIR/manuscript/Revisions/20241219/Supplementary_Figures/Figure_S15/tmp"
...
awk '{if($5 == "NUBPL"){print $4;}}' "$WORKDIR/PMD/references/target_genes.bed" | \
    ...
    > "$WORKDIR/manuscript/Revisions/20241219/Supplementary_Figures/Figure_S15/tmp/input.gtf"
...
echo -e "Haplotype 1\t$WORKDIR/manuscript/Revisions/20241219/Supplementary_Tables/Table_S6/Q1687/NUBPL/hap1_reads.bam\t1" \
    > "$WORKDIR/manuscript/Revisions/20241219/Supplementary_Figures/Figure_S15/tmp/input_bam.txt"
...
(singularity run -B "$WORKDIR" docker://guigolab/ggsashimi:v1.1.5 -b "$WORKDIR/manuscript/Revisions/20241219/Supplementary_Figures/Figure_S15/tmp/input_bam.txt" \
    -c "chr14:31561404-31859418" -o "$WORKDIR/manuscript/Revisions/20241219/Supplementary_Figures/Figure_S15/Figure_S15a" -M 80 \
    -g "$WORKDIR/manuscript/Revisions/20241219/Supplementary_Figures/Figure_S15/tmp/input.gtf" --shrink -C 3 --alpha 1 --height 1 \
    --ann-height 0.5 --width 3.5 --base-size 6) > /dev/null 2>&1

rm -rf "$WORKDIR/manuscript/Revisions/20241219/Supplementary_Figures/Figure_S15/tmp"
