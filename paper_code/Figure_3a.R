...
# (a) Number of RNA processing defects observed for splice site region variants that were previously identified from clinical testing. 
# Variants located in the -3 to +6 region of the donor splice site or the -20 to +3 region of the acceptor splice site were 
# classified as "splice site region" variants. 
...
outfile <- file.path(workdir, "manuscript/Revisions/20241219/Main_Figures/Figure_3/Figure_3a.pdf")
...
outDF <- bind_rows(outDF, tibble(ID = "Q1363", Gene = "MRPS34", Variant = "chr16:1772656 C>T", Variant_Class = "A", 
...
outDF <- bind_rows(outDF, tibble(ID = "Q2319", Gene = "SUCLG1", Variant = "chr2:84449761 T>C", Variant_Class = "A", 
...
outDF <- bind_rows(outDF, tibble(ID = "Q1695", Gene = "ELAC2", Variant = "chr17:13016933 CT>A", Variant_Class = "A", 
...
outDF <- bind_rows(outDF, tibble(ID = "Q1819", Gene = "TRIT1", Variant = "chr1:39850120 T>C", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "CDG-147-1", Gene = "PIGN", Variant = "chr18:62143306 C>T", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "AnJa", Gene = "PIGN", Variant = "chr18:62106985 C>G", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "CDG-137-1", Gene = "PIGN", Variant = "chr18:62106985 C>G", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "Q1663", Gene = "ATP5MK", Variant = "chr10:103392370 C>G", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "Q1687", Gene = "NUBPL", Variant = "chr14:31826715 G>A", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "CDG-132-1", Gene = "PIGQ", Variant = "chr16:576255 G>A", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "Q1964", Gene = "ATP5PO", Variant = "chr21:33914447 T>C", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "Q1513", Gene = "FBXL4", Variant = "chr6:98880546 CACTT>C", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "Q2032s1", Gene = "OPA1", Variant = "chr3:193643448 AG>A", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "AnJa", Gene = "PIGN", Variant = "chr18:62113129 C>T", Variant_Class = "D", 
...
outDF <- bind_rows(outDF, tibble(ID = "CDG-161-1", Gene = "PIGN", Variant = "chr18:62113129 C>T", Variant_Class = "D", 
