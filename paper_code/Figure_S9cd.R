...
palette <- setNames(c("#8EBEDA", "#FCB93F", "#FAAC90", "#F97D5F"), seq(length(keepTranscripts), 1))
...
palette <- setNames(c("#8EBEDA", "#FCB93F", "#FAAC90", "#F97D5F", "#BDBDBD"), c(recode(rev(keepTranscripts)[as.integer(names(newTxAssign))], 
